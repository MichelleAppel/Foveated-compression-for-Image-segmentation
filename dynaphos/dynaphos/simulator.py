...
from .cortex_models import get_cortical_magnification
from .image_processing import scale_image, to_n_dim
from .utils import (to_tensor, get_data_kwargs, get_truncated_normal,
...
class GaussianSimulator:
    ...
    def sample_stimulus(self, activation_mask: Union[np.ndarray, torch.Tensor]
        ...
        if self._sampling_method == 'receptive_fields':
            ...
            raise NotImplementedError
        return torch.mul(electrode_activation, 0.05) # stim. current = scale * electrode activations
